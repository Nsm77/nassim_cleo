...
function runMigrations(PDO $pdo): void {
    ...
    // Seed a development convenience admin ONLY outside production.
    // In production app_env defaults to 'production' (see config.php), so no
    // guessable default credential is ever created. Use api/system/setup.php to
    // provision the first real Super Admin.
